...
import projetoPortalLeadTaxImage from "@/assets/image/projetos/projeto_portal_leadtax.png";
import projetoBeeCareImage from "@/assets/image/projetos/projeto_beecare.png";
      ...
      <div className="flex flex-col items-center gap-10 px-4 sm:px-8 lg:px-24">
        ...
        >
          <CardLink 
            ...
            srcImage={projetoPortalLeadTaxImage}
            topics={[
